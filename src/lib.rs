...
#[derive(Debug)]
pub struct K6PerfProcessor {
    verbose: bool,
    processed_count: usize,
}

impl K6PerfProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting K6Perf processing");
    
    let mut processor = K6PerfProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = K6PerfProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = K6PerfProcessor::new(false);
